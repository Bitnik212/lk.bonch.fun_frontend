    ...
    <b-navbar-nav class="align-items-center ml-auto ml-md-0">
      ...
      <base-dropdown menu-on-right
        ...
        <a href="#" class="nav-link pr-0" @click.prevent slot="title-container">
          <b-media no-body class="align-items-center">
            ...
            <b-media-body class="ml-2 d-none d-lg-block">
              <span class="mb-0 text-md  font-weight-bold">Bit</span>
            </b-media-body>
          </b-media>
        </a>
        ...
        <template>
          ...
          <router-link to="/profile" class="b-dropdown-item">
          ...
          <router-link class="b-dropdown-item" to="/login">
...
.b-dropdown-item:active, .b-dropdown-item:link, .b-dropdown-item:visited{
