        ...
        <div class="header-body text-center mb-7">
          <b-row class="justify-content-center">
            <b-col xl="5" lg="6" md="6" class="px-5">
              <h1 class="text-light">Bruh ты куда пришел ?!</h1>
              <p class="text-lead text-white">А ну сьебал от сюда!!!!</p>

              <router-link to="/dashboard" class="font-weight-bold text-white mt-5">Вернуться на домашную сраницу</router-link>
            </b-col>
          </b-row>
        </div>
      </b-container>
